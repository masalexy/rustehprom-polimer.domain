...
function wccm_process_button_action() {
	...
	switch ( $action ) {
		...
		case 'remove-from-compare-list': wccm_remove_product_from_compare_list( $product_id ); break;
		case 'remove-from-wish-list': wccm_remove_product_from_wish_list( $product_id ); break;
	}
...
function wccm_add_product_to_wish_list( $product_id ) {
	$product = wc_get_product( $product_id );
	if ( !$product ) {
		return;
	}
...
function wccm_remove_product_from_wish_list( $product_id ) {
	$list = wccm_get_wish_list();
